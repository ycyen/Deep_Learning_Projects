...
def prepare_single_multi_task_data(data_dir, in_vocab_size, out_vocab_size):
    train_path = data_dir + '/train/train'
    test_path = data_dir + '/test/test'
    ...
    return (in_seq_train_ids_path, out_seq_train_ids_path, label_train_ids_path, in_seq_test_ids_path,
          in_vocab_path, out_vocab_path, label_path)