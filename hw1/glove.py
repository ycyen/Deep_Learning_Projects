...
class GloVeModel():
    ...
    def __fit_to_corpus(self, corpus, vocab_size, min_occurrences, left_size, right_size):
        ...
        for region in corpus:
            ...
            for l_context, word, r_context in _context_windows(region, left_size, right_size):
                #print(word,":", l_context, r_context)
        ...
        print("creating cooccurrence_matrix.......") #debug
    ...
    def print_words(self):
        print(self.__words)
    def print_embbedding(self):
        print(self.__embeddings)
...
#start here
model = GloVeModel(embedding_size=128, context_size=8)
print("Create model")
